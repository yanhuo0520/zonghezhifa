var util = {
		options: {
			ACTIVE_SRC1: "images/monitor_click.png",
			NORMAL_SRC1: "images/monitor_nor.png",
			ACTIVE_SRC2: "images/enclosure_click.png",
			NORMAL_SRC2: "images/enclosure_nor.png",
			ACTIVE_SRC3: "images/disinfection_click.png",
			NORMAL_SRC3: "images/disinfection_nor.png",
			ACTIVE_SRC4: "images/analysis_click.png",
			NORMAL_SRC4: "images/analysis_nor.png",
			ACTIVE_SRC5: "images/personal_click.png",
			NORMAL_SRC5: "images/personal_nor.png",
			subpages: [{
		...
		toggleNview: function(currIndex) {
			...
			switch (currIndex) {
				case 0:
					...
					util.updateSubNView(4, util.options.NORMAL_SRC5);
					break;
				case 1:
				...
				case 4:
					...
					util.updateSubNView(2, util.options.NORMAL_SRC3);
					util.updateSubNView(3, util.options.NORMAL_SRC4);
					util.updateSubNView(4, util.options.ACTIVE_SRC5);
					break;
			}
		},
		/*
