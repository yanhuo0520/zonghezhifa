...
function(e, t) {
	...
	var i = '<div class="mui-dtpicker" data-type="alltime">'+
	...
	e.DtPicker = e.Class.extend({
		init: function(n) {
			...
			s.cancel.addEventListener("tap", function() {
				...
				(a.options.beginMonth || a.options.endMonth) && a._createSeconds()
		...
		getSelected: function() {
			...
			switch(i) {
				case "alltime":
					n.value = n.y.value + "-" + n.m.value + "-" + n.d.value + " " + n.h.value + ":" + n.i.value + ":" + n.s.value, n.text = n.y.text + "-" + n.m.text + "-" + n.d.text + " " + n.h.text + ":" + n.i.text + ":" + n.s.text;
					break;
				case "datetime":
				...
				i.m.picker.setSelectedValue(n.m, 0, function() {
					i.d.picker.setSelectedValue(n.d, 0, function() {
						i.h.picker.setSelectedValue(n.h, 0, function() {
							i.i.picker.setSelectedValue(n.i, 0,function(){
								i.s.picker.setSelectedValue(n.s, 0)
							})
						})
					})
				})
		...
		_isbeginMinutes: function() {
			return this._isBeginHours() && this.options.beginSeconds === parseInt(this.ui.i.picker.getSelectedValue())
		},
		_isEndYear: function() {
		...
		_createSeconds: function(e) {
			...
			if(i.customData.i) a = i.customData.i;
				...
				for(var r = t._isbeginMinutes() ? i.beginSeconds : 0, s = t._isEndMinutes() ? i.endSeconds : 59; s >= r; r++) {
					var c = t._fill(r);
					a.push({
						text: c,
						value: c
		...
		_parseValue: function(e) {
			...
			if(e) {
				...
				t.y = i[0], t.m = i[1], t.d = i[2], t.h = i[3], t.i = i[4], t.s = i[5]
			} else {
				var n = new Date;
				t.y = n.getFullYear(), t.m = n.getMonth() + 1, t.d = n.getDate(), t.h = n.getHours(), t.i = n.getMinutes(), t.s = n.getSeconds()
			}
			return t
		},
		_create: function(e) {
			var t = this;
			e = e || {}, e.labels = e.labels || ["年", "月", "日", "时", "分", "秒"], e.buttons = e.buttons || ["取消", "确定"], e.type = e.type || "alltime", e.customData = e.customData || {}, t.options = e;
			var i = new Date,
				n = e.beginDate;
			n instanceof Date && !isNaN(n.valueOf()) && (e.beginYear = n.getFullYear(), e.beginMonth = n.getMonth() + 1, e.beginDay = n.getDate(), e.beginHours = n.getHours(), e.beginMinutes = n.getMinutes(),e.beginSeconds = n.getSeconds());
			var a = e.endDate;
			a instanceof Date && !isNaN(a.valueOf()) && (e.endYear = a.getFullYear(), e.endMonth = a.getMonth() + 1, e.endDay = a.getDate(), e.endHours = a.getHours(), e.endMinutes = a.getMinutes(), e.endSeconds = a.getSeconds()), e.beginYear = e.beginYear || i.getFullYear() - 5, e.endYear = e.endYear || i.getFullYear() + 5;//默认起止年份为：当前年前后加减5
			var r = t.ui;
			t._setLabels(), t._setButtons(), r.picker.setAttribute("data-type", e.type), t._createYear(), t._createMonth(), t._createDay(), t._createHours(), t._createMinutes(),t._createSeconds(), t.setSelectedValue(e.value)
		},
		show: function(i) {
			var n = this,
				a = n.ui;
