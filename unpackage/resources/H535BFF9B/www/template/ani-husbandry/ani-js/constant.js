...
var Constant = (function() {
  ...
  var constants = {//定义了两个常量
		...
		COMPANY_DIE_LIST:MAIN_URL+"/jyharmless/harmless/app/breed/appBreed_findDeadLogs.action",  // 企企业死亡记录
		COMPANY_CHULAN_LIST:MAIN_URL+"/jyharmless/harmless/app/breed/appBreed_findbreedingOutLogs.action",  // 企企业出栏记录
		COMPANY_CHULAN_LIST_NUM:MAIN_URL+"/jyharmless/harmless/app/breed/appBreed_findTotalNum.action",  // 企企业出栏记录
